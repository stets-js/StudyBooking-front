  ...
  return (
    <section>
      ...
      <div
        ...
        {modal === 'new-user' && <NewUser isOpen={isOpen} handleClose={() => handleClose()} />}
        <button
        ...
        {modal === 'new-course' && <NewCourse isOpen={isOpen} handleClose={() => handleClose()} />}
        <button
        ...
        {modal === 'change-course' && (
          <ChangeCourse isOpen={isOpen} handleClose={() => handleClose()} id={courseId} />
        )}
        <button
        ...
        {modal === 'new-group' && (
          <NewGroup isOpen={isOpen} handleClose={() => handleClose()} id={courseId} />
        )}
        <button
        ...
        {modal === 'change-group' && (
          <ChangeGroup isOpen={isOpen} handleClose={() => handleClose()} id={groupId} />
        )}
        <button
        ...
        {modal === 'new=appointment' && (
          <NewAppointment isOpen={isOpen} handleClose={() => handleClose()} id={groupId} />
        )}
        <button
          data-modal="settings"
          onClick={() => {
        ...
        {modal === 'settings' && (
          <SettingsModal isOpen={isOpen} handleClose={() => handleClose()} id={groupId} />
        )}
        <button
          data-modal="signup"
          onClick={() => {
        ...
        {modal === 'signup' && <SignUp isOpen={isOpen} handleClose={() => handleClose()} />}
        <button
          data-modal="login"
          onClick={() => {
            setIsOpen(!isOpen);
        ...
        {modal === 'login' && <Login isOpen={isOpen} handleClose={() => handleClose()} />}
        ...
        {modal === 'search-by-crm' && (
          <ChangeAppointment isOpen={isOpen} handleClose={() => handleClose()} />
        )}
      </div>
    </section>
  );
